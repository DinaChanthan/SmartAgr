...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="#" class="bars"></a>
                <a class="navbar-brand" href="{{ route('ecosystem') }}">Smart Agriculture</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2017 - 2019 <a href="{{ route('ecosystem') }}">Smart Agriculture</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            Smart Agriculture Product Images
