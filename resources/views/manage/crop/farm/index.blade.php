    ...
    <body class="theme-green">
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a href="#" class="bars"></a>
                    <a class="navbar-brand" href="{{ route('crop') }}">Smart Agriculture</a>
                </div>
        ...
        <section>
            ...
            <aside id="leftsidebar" class="sidebar">
                    ...
                    <div class="legal">
                        <div class="copyright">
                            &copy; 2018 - 2019 <a href="{{ route('crop') }}">Smart Agriculture</a>.
                        </div>
                        <div class="version">
                            <b>Version: </b> 1.0.0
                        </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="block-header">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#defaultModal">Add New Farm</button>
                </div>
                <!-- Default Media -->
                            ...
                            <div class="body">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="{{ route('farm.show', $farm->id) }}">
                                            <img class="media-object" src="{{ asset('uploads/images/farm/'.$farm->image) }}" width="64" height="64">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading">{{ $farm->name }}</h4> 
                                        {{ $farm->description }}
                                    </div>
                                </div>
                                @endforeach
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 style="text-align: center;" class="modal-title" id="defaultModalLabel">Create New Farm</h4>
                        </div>
